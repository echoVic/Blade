...
* 参考
  ...
  * [Durable Follow-up Queue](reference/follow-up-queue.md)
  * [Durable Follow-up Queue 资格验证证据](testing/durable-follow-up-queue-evidence.md)
  ...
  * [Durable Goal 回合链](reference/goal-turn-lineage.md)
  ...
  * [Provider 恢复状态资格验证证据](testing/provider-recovery-surface-evidence.md)
  * [Provider 429 共享冷却资格验证证据](testing/provider-rate-limit-cooldown-evidence.md)
